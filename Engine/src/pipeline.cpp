...
namespace vke {
    ...
    VkePipeline::VkePipeline(
        ...
        const PipelineConfigInfo& configInfo) : vkeDevice(device){
    ...
    void VkePipeline::createGraphicsPipeline(
        ...
        // how to define shader to engine
        ...
        if (vkCreateGraphicsPipelines(vkeDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS){
